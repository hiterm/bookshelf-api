...
use crate::{
    infrastructure::{
        ...
        import_books_service::PgImportBooksService, user_repository::PgUserRepository,
    },
...
pub type MI = MutationInteractor<
    ...
    ImportBooksInteractor<PgImportBooksService>,
>;
...
pub fn dependency_injection(
    ...
    let import_books_service = PgImportBooksService::new(pool.clone());
    ...
    let import_books_use_case = ImportBooksInteractor::new(import_books_service);
