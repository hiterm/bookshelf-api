...
- [x] 2.3 Verify the pull request CI logs show Headless Shell-only provisioning and successful frontend integration tests without a material test-time regression.
