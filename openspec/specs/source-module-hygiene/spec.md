# source-module-hygiene Specification

## Purpose

Define source-layout constraints that remove obsolete top-level modules while preserving observable behavior and active dependencies.
