...
Define portable, versioned state and full backup export and restore behavior,
...
- **THEN** the response contains state data plus event sets, Book events, and Author events
